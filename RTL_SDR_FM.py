...
class RTL_SDR_FM(gr.top_block, Qt.QWidget):
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(2, self.samp_rate, 100e3, 50e3, window.WIN_HAMMING, 6.76))
