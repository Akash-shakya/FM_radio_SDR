...
class RTL_SDR_FM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "RTL_SDR_FM")
        ...
        self.Tune = Tune = 104.3

        ##################################################
        # Blocks
        ##################################################
        self._Tune_range = Range(88.7, 110.1, 0.2, 104.3, 200)
        ...
        labels = ['Filtered_Real', 'Filtered_Img', 'Signal 3', 'Signal 4', 'Signal 5',
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_2.set_frequency_range(0, self.samp_rate/5/10)
